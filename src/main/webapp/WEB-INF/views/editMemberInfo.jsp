...
<body>
	<div class="container">
		<div class="py-5 text-center">
			...
			<div class="row align-items-center" style="width:50%;margin:0px auto" id="signUp">
			<form class="row g-3 needs-validation" novalidate method="POST"  action="/board/member/memberinfoChange"  id=form-signin autocomplete="off">
				<div>
					<label for="username" class="form-label"></label> 
					<input autocomplete="false"
						type="text" class="form-control" id="username" name="userId"
						placeholder="ID" required value=${member1.getUserId()} readonly>
				</div>
				...
				<div id="div1" class="text-center mt-0">
					...
					<button id=signUpbtn class="btn btn-primary btn-lg  bg-dark mb-2"
						type="submit"  onclick="signUp('signUp')">수정하기</button>	
